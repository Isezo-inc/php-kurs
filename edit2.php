...
$sql = "SELECT `id`, `plate`, `avto`, `name` FROM `tc` WHERE `id`=$id";
$result = mysql_query($sql);
$myrow = mysql_fetch_array($result);
    ?> 

<form action = "ed2.php" method="post">
<?php echo "<input type='text' hidden name='id' value='{$myrow['id']}'> " ?>

<input type="text" name="avto" <?php echo "value='{$myrow['avto']}'"?> placeholder = "Регистрационный номер"/><br>
<input type="text" name="plate" <?php echo "value='{$myrow['plate']}'"?> placeholder = "Название авто"/><br>
